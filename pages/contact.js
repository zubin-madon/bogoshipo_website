...
function Contact() {
  ...
  const [state, handleSubmit] = useForm("mbjweqyn");
    ...
    if (state.succeeded) {
        console.log(state)
                return <p className="text-2xl text-primary-focus py-24 text-center">Thanks! We will get back to you ASAP! For a faster response DM us on <a className="text-accent-content" href="https://twitter.com/bogoshipo_pets" target="_blank" alt="twitter">Twitter.</a></p>;
        }
      ...
      />
            ...
            <div className="p-2 w-full pt-8 mt-8 border-t border-gray-800 text-center">
              ...
              <span className="inline-flex">
                ...
                <a className="px-5" href="https://twitter.com/bogoshipo_pets" target="_blank" alt="Twitter">
                ...
                <a className="px-5" href="https://discord.gg/zddfzcNRCV" target="_blank" alt="Discord">
