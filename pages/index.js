  ...
  return (
    <Fragment>
      <Head>
        ...
        <meta name="description" content="Project Introduction to Upcoming Blockchain Pet Game" />
        <meta charset="utf-8" />
        ...
        <meta property="og:image" content="https://www.bogoshipo.com/logo512.png" />
  ...
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
      ...
      <div className="flex lg:flex-row md:flex-col text-gray-300">
        <button className="bg-gray-800 inline-flex py-3 px-5 rounded-lg items-center hover:bg-gray-700 hover:text-white focus:outline-none">
          ...
          <span className="ml-4 flex items-start flex-col leading-none">
            <span className="text-xs text-neutral-content mb-1">COMING SOON</span>
    ...
    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 animate-pulse">
          ...
          <div className="display">
            ...
            <Image className="object-cover object-center rounded" layout="intrinsic" width={310} height={570} alt="hero" src="/assets/phone_preview.png" />
            </div>
          </div>
        </div>
