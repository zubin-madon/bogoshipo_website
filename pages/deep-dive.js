    ...
    <Fragment>
      <div className="carousel w-full">
        <div id="slide1" className="carousel-item relative w-full">
          <div className="px-96 py-36 justify-center">
            <div className="card card-side shadow-xl bg-primary-content">
              <h1 className="text-6xl text-base-content p-3">
                What Makes Bogoshipo Unique?
              </h1>
              <div className="card-body">
                <p className="text-primary text-3xl text-justify">
                  Bogoshipo will be initially launched as a completely server
                  less game. The client app will update the game state in
                  increments to the blockchain. Every client will be able to
                  perfectly rebuild the game-world using on-chain data. As the
                  game becomes popular and more users get on board, there is the
                  possibility of leveraging decentralized file-sharing platforms
                  to offload computation for low-powered client hardware without
                  sacrificing the ability to fully verify the game state. <br />
                  <b>
                    Bogoshipo will be simultaneously released as
                    Android/iOS/Win10 builds.
                  </b>
                </p>
        ...
        <div id="slide2" className="carousel-item relative w-full">
          <div className="px-36 py-36 justify-center">
            <div className="card card-side shadow-xl bg-primary-content">
              <div className="card-body">
                <h1 className="text-6xl text-base-content p-3">
                  Breeding Algorithm
                </h1>
                <p className="text-primary text-2xl text-justify">
              ...
              <div className="card-body">
                <h1 className="text-6xl text-base-content p-3">Mini-games</h1>
                <p className="text-primary text-2xl text-justify">
                  ...
                  increase the pet&apos;s health and happiness quotient. We plan to
                  add a p2e component into the mix.
                </p>
                <div className="card-actions justify-end"></div>
              </div>
            ...
            <div className="card-body">
                <h1 className="text-6xl text-base-content p-3">Pet Memorial</h1>
                <p className="text-primary text-2xl text-justify">
                Deceased pets will be immortalized in the “pet memorial” within the game. 
                Users will also have the option of making custom designed NFTs as memorials on 
                our upcoming platform eternally.live. Eternally will be an NFT platform 
                where users can memorialize departed loved ones.
                </p>
                <div className="card-actions justify-end"></div>
              </div>
            </div>
            ...
            <div className="card card-side shadow-xl bg-primary-content">
              ...
              <div className="card-body">
                ...
                <tbody>
                  ...
                  <tr>
                    <td className="border border-primary-focus">BodyPart[]</td>
                  </tr>
                  <tr>
                ...
                <tbody>
                  ...
                  <tr>
                    <td className="border border-primary-focus">Inheritable</td>
                  </tr>
                  <tr>
                    <td className="border border-primary-focus">
                      InheritableChance
            ...
            <div className="card card-side shadow-xl bg-primary-content">
              ...
              <div className="card-body">
                ...
                <tbody>
                  ...
                  <tr>
                    <td className="border border-primary-focus">Ears: 50% </td>
